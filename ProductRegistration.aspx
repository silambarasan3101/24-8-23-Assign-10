<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRegistration.aspx.cs" Inherits="_24_8_23_Assign_10.ProductRegistration" %>
...
<body>
    ...
    <form id="form1" runat="server">             
        <div class="row">
             <div class="col-md-2"><asp:Image runat="server" ID="Image1" ImageUrl="E:\car\0.jpg"
                 Width="500" Height="150" CssClass="img-fluid" /></div>
             <div class="col-md-2" style="margin-left : 150px"><asp:Image runat="server" ID="Image2" ImageUrl="E:\car\1.jpg"
                 Width="500" Height="150" CssClass="img-fluid" /></div>            
         </div>
